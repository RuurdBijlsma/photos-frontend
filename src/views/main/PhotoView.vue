...
const images: (GalleryPhoto | GalleryVideo)[] = [
  ...
  },
  {
    ...
    medium: 'https://fastly.picsum.photos/id/127/1920/1080.jpg?hmac=tUwxvd6-glVoeBPFwke9_OgXuiRXo6nkorjL4pcBU94',
  ...
  },
  {
    ...
    medium: 'https://fastly.picsum.photos/id/237/1920/1080.jpg?hmac=1hPzsubx1j8fMddzUgP5NbuX2rNLOEaQML1rD_g1C5Y',
  ...
  },
  {
    ...
    medium: 'https://fastly.picsum.photos/id/692/1920/1080.jpg?hmac=Oq1BbdEMm2D6VOmB_sNxcxilNNFjY3cje_xZTn5onTk',
  ...
  },
  {
    ...
    medium: 'https://fastly.picsum.photos/id/705/1920/1080.jpg?hmac=ZunPnmcn7rFg_65607aE_udOxVHshBXTepX645_g7Cg',
  ...
  },
  {
    ...
    medium: 'https://fastly.picsum.photos/id/743/1920/1080.jpg?hmac=-HNSMW1n9zrX12RRMQSKExyi-RRw_f6-6GbZrm1esS0',
...
async function handleImage(image: GalleryVideo | GalleryPhoto) {
  ...
  if ('video' in image && vidContainer) {
    ...
    if (videoElement !== undefined)
      vidContainer.replaceChildren(videoElement)
...
const skip = (n: number = 0) => {
  ...
  handleImage(image).then(() => {
    if ('video' in image)
      console.log(imageLoader.getVideo(image))
  })
